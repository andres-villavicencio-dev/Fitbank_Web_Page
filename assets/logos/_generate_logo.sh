...
<svg xmlns="http://www.w3.org/2000/svg" width="320" height="120" viewBox="0 0 320 120">
  ...
  <rect width="100%" height="100%" fill="url(#g)" stroke="#0093EA" stroke-width="3" rx="14"/>
  <g>
    <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Segoe UI, Arial, sans-serif" font-size="28" fill="#0b1020" font-weight="700">$text</text>
  </g>
</svg>
SVG
}
...
chmod +x assets/logos/_generate_logo.sh
./assets/logos/_generate_logo.sh
ls -1 assets/logos | sort
